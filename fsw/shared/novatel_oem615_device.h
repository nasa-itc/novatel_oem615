...
#define NOVATEL_OEM615_DEVICE_HK_SIZE                                          \
  NOVATEL_OEM615_DEVICE_HK_LNGTH + NOVATEL_OEM615_DEVICE_HDR_TRL_LEN
...
#define NOVATEL_OEM615_DEVICE_DATA_LNGTH                                       \
  sizeof(NOVATEL_OEM615_Device_Data_tlm_t)
#define NOVATEL_OEM615_DEVICE_DATA_SIZE                                        \
  NOVATEL_OEM615_DEVICE_DATA_LNGTH + NOVATEL_OEM615_DEVICE_HDR_TRL_LEN
...
int32_t NOVATEL_OEM615_ReadHK(uart_info_t *uart_device, uint8_t *read_data,
                              uint8_t data_length);
int32_t NOVATEL_OEM615_CommandDevice(uart_info_t *uart_device, uint8_t cmd,
                                     uint32_t payload);
