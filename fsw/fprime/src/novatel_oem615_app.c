  ...
  while (CFE_ES_RunLoop(&local_run) == true) {
    ...
    */
    status = CFE_SB_ReceiveBuffer(
        (CFE_SB_Buffer_t **)&NOVATEL_OEM615_AppData.MsgPtr,
...
int32 NOVATEL_OEM615_AppInit(void) {
  ...
  */
  status = CFE_SB_CreatePipe(&NOVATEL_OEM615_AppData.CmdPipe,
                             NOVATEL_OEM615_PIPE_DEPTH, "NAV_CMD_PIPE");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(NOVATEL_OEM615_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(NOVATEL_OEM615_CMD_MID),
                            NOVATEL_OEM615_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(NOVATEL_OEM615_REQ_HK_MID),
                            NOVATEL_OEM615_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(NOVATEL_OEM615_SUB_REQ_HK_ERR_EID,
  ...
  ** telemetry that has been defined in the NOVATEL_OEM615_HkTelemetryPkt for
  *this app.
  */
  ...
  *available
  */
  NOVATEL_OEM615_AppData.Novatel_oem615Uart.deviceString =
      NOVATEL_OEM615_CFG_STRING;
  ...
  NOVATEL_OEM615_AppData.Novatel_oem615Uart.baud =
      NOVATEL_OEM615_CFG_BAUDRATE_HZ;
  NOVATEL_OEM615_AppData.Novatel_oem615Uart.access_option =
  ...
  *block
  */
  NOVATEL_OEM615_AppData.HkTelemetryPkt.DeviceEnabled =
      NOVATEL_OEM615_DEVICE_DISABLED;
  ...
  status = OS_MutSemCreate(&NOVATEL_OEM615_AppData.HkDataMutex,
                           NOVATEL_OEM615_HK_MUTEX_NAME, 0);
  if (status != OS_SUCCESS) {
    CFE_EVS_SendEvent(NOVATEL_OEM615_CREATE_MUTEX_ERR_EID,
                      CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_ES_CreateChildTask(
      &NOVATEL_OEM615_AppData.DeviceID, NOVATEL_OEM615_CHILD_TASK_NAME,
      NOVATEL_OEM615_ChildTask, 0, NOVATEL_OEM615_CHILD_TASK_STACK_SIZE,
      NOVATEL_OEM615_CHILD_TASK_PRIORITY, 0);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(NOVATEL_OEM615_CHILDTASKINIT_ERR_EID,
                      CFE_EVS_EventType_ERROR,
  ...
  */
  ...
  status = CFE_EVS_SendEvent(
      NOVATEL_OEM615_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
      "NOVATEL_OEM615 App Initialized. Version %d.%d.%d.%d",
      NOVATEL_OEM615_MAJOR_VERSION, NOVATEL_OEM615_MINOR_VERSION,
      NOVATEL_OEM615_REVISION, NOVATEL_OEM615_MISSION_REV);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "NOVATEL_OEM615: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
void NOVATEL_OEM615_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the NOVATEL_OEM615_CMD_MID
  *(Message ID)
  */
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_PROCESS_CMD_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Invalid command packet, MID = 0x%x",
...
void NOVATEL_OEM615_ProcessGroundCommand(void) {
  ...
  */
  case NOVATEL_OEM615_NOOP_CC:
    ...
    */
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_NOOP_INF_EID,
  ...
  */
  case NOVATEL_OEM615_ENABLE_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case NOVATEL_OEM615_DISABLE_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case NOVATEL_OEM615_LOG_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_Log_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(
          NOVATEL_OEM615_CMD_SERIALCONFIG_INF_EID,
          CFE_EVS_EventType_INFORMATION,
          "NOVATEL_OEM615: Log command received - %d, %d",
          ((NOVATEL_OEM615_Log_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)->LogType,
          ((NOVATEL_OEM615_Log_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)
              ->PeriodOption);
      NOVATEL_OEM615_SafeCommandDeviceCustom(
          NOVATEL_OEM615_LOG_CC,
          ((NOVATEL_OEM615_Log_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)->LogType,
          ((NOVATEL_OEM615_Log_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)
              ->PeriodOption);
    }
  ...
  */
  case NOVATEL_OEM615_UNLOG_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_Unlog_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(
          NOVATEL_OEM615_CMD_SERIALCONFIG_INF_EID,
          CFE_EVS_EventType_INFORMATION,
          "NOVATEL_OEM615: Unlog command received - %d",
          ((NOVATEL_OEM615_Unlog_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)
              ->LogType);
      NOVATEL_OEM615_SafeCommandDeviceCustom(
          NOVATEL_OEM615_UNLOG_CC,
          ((NOVATEL_OEM615_Unlog_cmd_t *)NOVATEL_OEM615_AppData.MsgPtr)
              ->LogType,
          -1);
    }
  ...
  */
  case NOVATEL_OEM615_UNLOGALL_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
                                       sizeof(NOVATEL_OEM615_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_SERIALCONFIG_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "NOVATEL_OEM615: Unlog all command received");
      NOVATEL_OEM615_SafeCommandDeviceCustom(NOVATEL_OEM615_UNLOGALL_CC, -1,
                                             -1);
    }
    break;
  ...
  */
  case NOVATEL_OEM615_SERIALCONFIG_CC:
    if (NOVATEL_OEM615_VerifyCmdLength(NOVATEL_OEM615_AppData.MsgPtr,
      ...
      NOVATEL_OEM615_SafeCommandDeviceCustom(NOVATEL_OEM615_SERIALCONFIG_CC, -1,
                                             -1);
    }
    break;
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
...
void NOVATEL_OEM615_ProcessTelemetryRequest(void) {
  ...
  */
  default:
    /* Increment the error counter upon receipt of an invalid command */
    NOVATEL_OEM615_IncrementCommandErrorCount();
    CFE_EVS_SendEvent(NOVATEL_OEM615_DEVICE_TLM_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
                      CFE_SB_MsgIdToValue(MsgId), CommandCode);
...
void NOVATEL_OEM615_ReportHousekeeping(void) {
  ...
  if (NOVATEL_OEM615_GetDeviceEnabledStatus() ==
      NOVATEL_OEM615_DEVICE_ENABLED) {
    status = NOVATEL_OEM615_SafeRequestHK(
        (NOVATEL_OEM615_Device_HK_tlm_t *)&NOVATEL_OEM615_AppData.HkTelemetryPkt
            .DeviceHK);
    if (status == OS_SUCCESS) {
      NOVATEL_OEM615_IncrementDeviceCount();
    } else {
      NOVATEL_OEM615_IncrementDeviceErrorCount();
      // This spams the NOS3 FSW window when uncommented because there usually
      // isn't any data available to be read, and that returns an error.
      /*
  ...
  CFE_SB_TimeStampMsg(
      (CFE_MSG_Message_t *)&NOVATEL_OEM615_AppData.HkTelemetryPkt);
  CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&NOVATEL_OEM615_AppData.HkTelemetryPkt, true);
  return;
}
...
void NOVATEL_OEM615_ReportDeviceTelemetry(void) {
  ...
  if (NOVATEL_OEM615_GetDeviceEnabledStatus() ==
    ...
    status = NOVATEL_OEM615_SafeRequestData(
        (NOVATEL_OEM615_Device_Data_tlm_t *)&NOVATEL_OEM615_AppData.DevicePkt
            .Novatel_oem615);
    if (status == OS_SUCCESS) {
      NOVATEL_OEM615_IncrementDeviceCount();
      /* Time stamp and publish data telemetry */
      CFE_SB_TimeStampMsg(
          (CFE_MSG_Message_t *)&NOVATEL_OEM615_AppData.DevicePkt);
      CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&NOVATEL_OEM615_AppData.DevicePkt,
                         true);
    } else {
      NOVATEL_OEM615_IncrementDeviceErrorCount();
      CFE_EVS_SendEvent(
          NOVATEL_OEM615_REQ_DATA_ERR_EID, CFE_EVS_EventType_ERROR,
...
void NOVATEL_OEM615_Enable(void) {
  ...
  if (NOVATEL_OEM615_GetDeviceEnabledStatus() ==
    ...
    if (status == OS_SUCCESS) {
      ...
      CFE_EVS_SendEvent(NOVATEL_OEM615_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "NOVATEL_OEM615: Device enabled");
    } else {
      NOVATEL_OEM615_IncrementDeviceErrorCount();
      CFE_EVS_SendEvent(
          NOVATEL_OEM615_UART_INIT_ERR_EID, CFE_EVS_EventType_ERROR,
...
void NOVATEL_OEM615_Disable(void) {
  ...
  if (NOVATEL_OEM615_GetDeviceEnabledStatus() ==
    ...
    if (status == OS_SUCCESS) {
      ...
      CFE_EVS_SendEvent(NOVATEL_OEM615_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "NOVATEL_OEM615: Device disabled");
    } else {
      NOVATEL_OEM615_IncrementDeviceErrorCount();
      CFE_EVS_SendEvent(NOVATEL_OEM615_UART_CLOSE_ERR_EID,
                        CFE_EVS_EventType_ERROR,
    ...
    NOVATEL_OEM615_IncrementDeviceErrorCount();
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_DISABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
*/
int32 NOVATEL_OEM615_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
...
/*
** Safely command device using NOVATEL-specific commands (LOG, UNLOG, UNLOGALL,
*SERIALCONFIG)
*/
int32 NOVATEL_OEM615_SafeCommandDeviceCustom(uint8_t cmd_code, int8_t log_type,
                                             int8_t period_option) {
  uint32 status;
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    status = NOVATEL_OEM615_CommandDeviceCustom(
        &NOVATEL_OEM615_AppData.Novatel_oem615Uart, cmd_code, log_type,
        period_option);
...
int32 NOVATEL_OEM615_SafeRequestHK(NOVATEL_OEM615_Device_HK_tlm_t *data) {
  ...
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    status = NOVATEL_OEM615_RequestHK(
        &NOVATEL_OEM615_AppData.Novatel_oem615Uart, data);

    OS_MutSemGive(NOVATEL_OEM615_AppData.HkDataMutex);
  } else {
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_MUT_REQUEST_HK_ERR_EID, CFE_EVS_EventType_ERROR,
...
int32 NOVATEL_OEM615_SafeRequestData(NOVATEL_OEM615_Device_Data_tlm_t *data) {
  ...
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    status = NOVATEL_OEM615_RequestData(
        &NOVATEL_OEM615_AppData.Novatel_oem615Uart, data);

    OS_MutSemGive(NOVATEL_OEM615_AppData.HkDataMutex);
  } else {
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_MUT_REQUEST_DATA_ERR_EID, CFE_EVS_EventType_ERROR,
...
int32 NOVATEL_OEM615_ChildProcessRequestData(
    NOVATEL_OEM615_Device_Data_tlm_t *data) {
  uint32 status;

  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    status = NOVATEL_OEM615_ChildProcessReadData(
        &NOVATEL_OEM615_AppData.Novatel_oem615Uart, data);

    OS_MutSemGive(NOVATEL_OEM615_AppData.HkDataMutex);
  } else {
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_REQUEST_DATA_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Request device data for child task "
                      "reported error obtaining mutex");
    status = CFE_ES_RunStatus_APP_ERROR;
  }
  return status;
}
...
void NOVATEL_OEM615_IncrementCommandCount(void) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_INC_CMD_CNT_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Increment command count reported error "
                      "obtaining mutex");
  }
  return;
}
...
void NOVATEL_OEM615_IncrementCommandErrorCount(void) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_INC_CMD_ERR_CNT_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Increment command error count reported "
                      "error obtaining mutex");
  }
  return;
}
...
void NOVATEL_OEM615_IncrementDeviceCount(void) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_INC_DEV_CNT_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Increment device count reported error "
                      "obtaining mutex");
  }
  return;
}
...
void NOVATEL_OEM615_IncrementDeviceErrorCount(void) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_INC_DEV_ERR_CNT_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Increment device error count reported "
                      "error obtaining mutex");
  }
  return;
}
...
void NOVATEL_OEM615_ResetCounters(void) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    OS_MutSemGive(NOVATEL_OEM615_AppData.HkDataMutex);
    CFE_EVS_SendEvent(NOVATEL_OEM615_CMD_RESET_INF_EID,
                      CFE_EVS_EventType_INFORMATION,
...
int32 NOVATEL_OEM615_GetRunStatus(void) {
  ...
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_MUT_GET_RUN_STATUS_ERR_EID, CFE_EVS_EventType_ERROR,
...
void NOVATEL_OEM615_SetRunStatus(uint32 status) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(
        NOVATEL_OEM615_MUT_SET_RUN_STATUS_ERR_EID, CFE_EVS_EventType_ERROR,
...
int32 NOVATEL_OEM615_GetDeviceEnabledStatus(void) {
  ...
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_GET_DEV_ENABLE_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Get device enabled status reported "
                      "error obtaining mutex");
    status = CFE_ES_RunStatus_APP_ERROR;
  }
  return status;
...
void NOVATEL_OEM615_SetDeviceEnabledStatus(uint32 status) {
  if (OS_MutSemTake(NOVATEL_OEM615_AppData.HkDataMutex) == OS_SUCCESS) {
    ...
    CFE_EVS_SendEvent(NOVATEL_OEM615_MUT_SET_DEV_ENABLE_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "NOVATEL_OEM615: Set device enabled status reported "
                      "error obtaining mutex");
  }
  return;
}