...
** This struct is defined in the `novatel_oem615_app.h` file with one global
*instance
** in the `.c` file.
*/
typedef struct {
  ...
  */
  NOVATEL_OEM615_Hk_tlm_t
      HkTelemetryPkt; /* NOVATEL_OEM615 Housekeeping Telemetry Packet */
...
*/
extern NOVATEL_OEM615_AppData_t
    NOVATEL_OEM615_AppData; /* NOVATEL_OEM615 App Data */
