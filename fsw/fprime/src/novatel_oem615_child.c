...
void NOVATEL_OEM615_ChildTask(void) {
  CFE_EVS_SendEvent(NOVATEL_OEM615_CHILDTASKINIT_INF_EID,
                    CFE_EVS_EventType_INFORMATION,
                    "NOVATEL_OEM615: child task started, runStatus = %d",
                    NOVATEL_OEM615_AppData.RunStatus);
  ...
  CFE_EVS_SendEvent(NOVATEL_OEM615_CHILDTASKEXIT_INF_EID,
                    CFE_EVS_EventType_INFORMATION,
...
void NOVATEL_OEM615_ProcessData(void) {
  ...
  if (NOVATEL_OEM615_GetDeviceEnabledStatus() ==
    ...
    if (status == OS_SUCCESS) {
      ...
      // CFE_EVS_SendEvent(NOVATEL_OEM615_UART_READ_ERR_EID,
      // CFE_EVS_EventType_ERROR,
      //    "(ChildTask) NOVATEL_OEM615_ProcessData: Device read error.
      //    NOVATEL_OEM615_ChildProcessRequestData returned %d.", status);
    }
  }
