...
void Test_NOVATEL_OEM615_AppMain(void) {
   ...
   */
  UtAssert_True(
      NOVATEL_OEM615_AppData.RunStatus == CFE_ES_RunStatus_APP_ERROR,
  ...
  UT_CheckEvent_Setup(&EventTest, NOVATEL_OEM615_PIPE_ERR_EID,
                      "NOVATEL_OEM615: SB Pipe Read Error = %d");
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "NOVATEL_OEM615_PIPE_ERR_EID generated (%u)",
...
void Test_NOVATEL_OEM615_ProcessCommandPacket(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 0,
                "NOVATEL_OEM615_CMD_ERR_EID not generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  NOVATEL_OEM615_ProcessCommandPacket();
  UtAssert_True(EventTest.MatchCount == 1,
                "NOVATEL_OEM615_CMD_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
...
void Test_NOVATEL_OEM615_ProcessGroundCommand(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "NOVATEL_OEM615_CMD_NOOP_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  NOVATEL_OEM615_ProcessGroundCommand();
  UtAssert_True(EventTest.MatchCount == 1,
                "NOVATEL_OEM615_CMD_RESET_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
...
void Test_NOVATEL_OEM615_ReportHousekeeping(void) {
  ...
  UtAssert_True(MsgTimestamp ==
                    &NOVATEL_OEM615_AppData.HkTelemetryPkt.TlmHeader.Msg,
...
void Test_NOVATEL_OEM615_VerifyCmdLength(void) {
   ...
   */
  UtAssert_True(EventTest.MatchCount == 0,
                "NOVATEL_OEM615_LEN_ERR_EID NOT generated (%u)",
                (unsigned int)EventTest.MatchCount);
   ...
   */
  UtAssert_True(EventTest.MatchCount == 1,
                "NOVATEL_OEM615_LEN_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
 ...
 */
void Novatel_oem615_UT_Setup(void) { UT_ResetState(0); }
