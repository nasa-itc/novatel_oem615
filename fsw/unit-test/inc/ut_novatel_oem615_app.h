 ...
 *
 * Purpose:
 * Extra scaffolding functions for the novatel_oem615_app unit test
 *
 * Notes:
...
#ifndef UT_NOVATEL_OEM615_APP_H
#define UT_NOVATEL_OEM615_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "NOVATEL_OEM615_APP_Data_t" typedef.
 */
