...
def confirm_gps_data()
    ...
    get_gps_data()
    diff = 10 # 10 meter tolerance
    ecef_pos = tlm("SIM_42_TRUTH SIM_42_TRUTH_DATA ECEF_POS")
    wait_check_tolerance("NOVATEL_OEM615 NOVATEL_OEM615_DATA_TLM ECEF_X", ecef_pos[0], diff, NOVATEL_OEM615_RESPONSE_TIMEOUT)
    wait_check_tolerance("NOVATEL_OEM615 NOVATEL_OEM615_DATA_TLM ECEF_Y", ecef_pos[1], diff, NOVATEL_OEM615_RESPONSE_TIMEOUT)
    wait_check_tolerance("NOVATEL_OEM615 NOVATEL_OEM615_DATA_TLM ECEF_Z", ecef_pos[2], diff, NOVATEL_OEM615_RESPONSE_TIMEOUT)
